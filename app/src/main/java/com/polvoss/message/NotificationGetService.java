...
import com.polvoss.overlay.OverlayServiceSMS;
import com.polvoss.etc.TrustedWebsite;
...
public class NotificationGetService extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        if (!powerState || !kakaoState ) {
            Log.d("NotificationListener", "power = " + powerState);
            Log.d("NotificationListener", "kakao = " + kakaoState);
            return;
        }

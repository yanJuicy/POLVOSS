...
public class OverlayService1 extends Service {
    WindowManager wm;
    View mView;
    @Override
    ...
    public void onCreate() {
        ...
        mView = inflate.inflate(R.layout.activity_overlay_1, null);
        ...
        */
        ...
        final TextView textView = mView.findViewById(R.id.accepttext1);

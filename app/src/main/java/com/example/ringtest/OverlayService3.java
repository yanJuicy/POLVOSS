...
public class OverlayService3 extends Service {
    WindowManager wm;
    View mView;
    @Override
    ...
    public void onCreate() {
        ...
        mView = inflate.inflate(R.layout.activity_overlay_3, null);
        ...
        */
        final ImageButton bt =  mView.findViewById(R.id.imagebutton3);
        final TextView textView = mView.findViewById(R.id.accepttext3);
